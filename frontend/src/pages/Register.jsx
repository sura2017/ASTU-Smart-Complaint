  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex flex-col items-center justify-center p-2 sm:p-4 font-sans relative overflow-hidden">
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-white/20">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 py-4 px-6 text-center text-white">
             <div className="flex items-center justify-center gap-3">
                ...
                <h2 className="text-xl font-black tracking-tight">Create Account</h2>
             </div>
             <p className="text-blue-100/60 text-[10px] font-bold uppercase tracking-widest mt-1">Smart Complaint Portal</p>
          </div>
          ...
          <div className="p-6 sm:p-8 space-y-4">
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <button 
                disabled={loading}
                type="submit" 
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-3.5 rounded-xl shadow-lg transition-all active:scale-95 flex justify-center items-center gap-2 text-xs tracking-widest mt-2"
              >
      ...
      <div className="mt-6 flex justify-center gap-4 text-slate-500 text-[9px] font-black uppercase tracking-widest opacity-40">
            <span>ASTU Registration Help</span>
